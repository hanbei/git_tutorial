...
\begin{figure} 
\centering
  \includegraphics[scale=0.4]{images/long-running-branch.png}
\end{figure}
\end{frame}
...
\begin{figure} 
\centering
  \includegraphics[scale=0.4]{images/long-running-branch2.png}
\end{figure}
\end{frame}
...
\begin{figure} 
\centering
  \includegraphics[scale=0.3]{images/long-running-branch3.png}
\end{figure}
\end{frame}
